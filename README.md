...
[Tải cho macOS (.dmg)](https://github.com/klee3721/NiceKey/releases/download/v1.2.0/NiceKey-1.2.0.dmg) | [Tải cho Windows (.exe)](https://github.com/klee3721/NiceKey/releases/download/v1.2.0/NiceKey-1.2.0-Windows-Setup.exe)
...
- Bổ sung danh sách loại trừ thủ công trên macOS và Windows: ứng dụng đã chọn luôn nhận phím tiếng Anh mà không làm thay đổi chế độ Việt/Anh chung.
- Tự phục hồi bộ nghe bàn phím khi macOS hoặc Windows vô hiệu hóa hook, tránh phải thoát và mở lại NiceKey sau khi máy hoặc ứng dụng bị treo ngắn.
...
[NiceKey-1.2.0.dmg](https://github.com/klee3721/NiceKey/releases/download/v1.2.0/NiceKey-1.2.0.dmg)

Mở file `.dmg`, kéo `NiceKey.app` vào thư mục `Applications`, sau đó mở NiceKey từ Applications.

## Cài đặt Windows

Tải [NiceKey-1.2.0-Windows-Setup.exe](https://github.com/klee3721/NiceKey/releases/download/v1.2.0/NiceKey-1.2.0-Windows-Setup.exe), mở bộ cài và chọn `Mở NiceKey` sau khi hoàn tất. Bản cài hỗ trợ Windows 10 phiên bản 1809 trở lên và Windows 11, tự chọn executable x64 hoặc x86 phù hợp.
...
Trên cả macOS và Windows, để buộc một ứng dụng luôn gõ tiếng Anh, bật `Loại trừ ứng dụng thủ công`, mở tab `Loại trừ`, chọn ứng dụng đang chạy rồi bấm nút `+`. Bấm nút `-` hoặc nhấp đúp ứng dụng ở danh sách phía trên để xóa khỏi danh sách loại trừ.
